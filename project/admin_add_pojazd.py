...
class Ui_MainWindow(object):
    ...
    def add_pojazd(self):
        nazwa_pojazdu = self.lineEdit.text()
        numer = self.lineEdit_2.text()

        if len(nazwa_pojazdu) < 3:
            self.warning_manager.showWarningBox('error', 'nie prawydlowa nazwa')
            return None

        else:
            check_exception = self.db.add_pojazd(nazwa_pojazdu, numer)
            if check_exception:
    ...
    def setupUi(self, MainWindow):
        ...
        ############### Button Event ####################
        self.pushButton.clicked.connect(self.add_pojazd)
        # ###############################################
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Dodanie Pojazdu"))
        self.label.setText(_translate("MainWindow", "Dodanie Pojazdu"))
        self.label_2.setText(_translate("MainWindow", "Nazwa pojazdu: "))
